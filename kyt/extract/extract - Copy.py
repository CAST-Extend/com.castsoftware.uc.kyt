...
from extract import query_listAllTransactionObjects
from extract import query_listAllTransactions
...
configTransactions=query_boilerplate.TQueryConfig(
...
configTransactionLinks=query_boilerplate.TQueryConfig(
...
configTransactionEndpoints=query_boilerplate.TQueryConfig(
...
WHERE 1=1
    ...
    --)
"""
configTransactionObjectsWithCV=query_boilerplate.TQueryConfig(
...
configTransactionObjectsWithCriticalViolations=query_boilerplate.TQueryConfig(
	countH	= "#NbOfTransactionObjectsWithVC",
	countQ	= """SELECT COUNT(0) FROM (
-- -- -- begin -- -- --
--
...
configTransactionObjectsWithV=query_boilerplate.TQueryConfig(
...
configTransactionObjectsWithViolations=query_boilerplate.TQueryConfig(
	countH	= "#NbOfTransactionViolations",
	countQ	= """SELECT COUNT(0) FROM (
-- -- -- begin -- -- --
--
...
"""
configTransactionObjPro=query_boilerplate.TQueryConfig(
	countH	= "#NbOfObjproId",
	countQ	= """SELECT COUNT(0) FROM (
-- -- -- begin -- -- --
--
...
def extractTransactionData( aOptions ):
    ...
    if None != aCriteria:
        ...
        queries = [
            ( "List-of-all-transactions", False, query_listAllTransactions.configAllTransactions.selectQ, ( aConfig['db-local'],), query_listAllTransactions.configAllTransactions.selectH, "00b_all-transactions.txt", False, False, None ),
            ...
            ( "List-of-transaction-objects", False, query_listAllTransactionObjects.configTransactionObjects.selectQ, ( aConfig['db-local'], vCriteriaValue, aCriteria), query_listAllTransactionObjects.configTransactionObjects.selectH, "10b_transaction-objects.txt", False, False, None ),
